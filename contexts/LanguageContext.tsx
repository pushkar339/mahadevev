...
const translations = {
  en: {
    ...
    cta: {
      ...
      showroom: "Showroom",
      address: ["N.H. 58, Delhi-Roorkee Highway,", "Baghpat Road Bypass Crossing,", "Meerut, Uttar Pradesh 250005 India"],
  ...
  hi: {
    ...
    cta: {
      ...
      showroom: "शोरूम",
      address: ["राष्ट्रीय राजमार्ग 58, दिल्ली-रुड़की राजमार्ग,", "बाघपत रोड बाईपास क्रॉसिंग,", "मेरठ, उत्तर प्रदेश 250005 भारत"],
